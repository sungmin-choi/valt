...
class TextStyles {
  ...
  static const pretendardN16Gray90w700 = TextStyle(
      ...
      fontWeight: FontWeight.w700,
      color: ColorStyles.gray90);
  static const pretendardN16Gray60w400 = TextStyle(
      fontFamily: 'Pretendard',
      fontSize: 16,
      fontStyle: FontStyle.normal,
  ...
  static const pretendardB16Gray50 = TextStyle(
      fontFamily: 'Pretendard',
      fontSize: 16,
      fontWeight: FontWeight.bold,
...
//17
  ...
  static const pretendardB14Gray60 = TextStyle(
      ...
      fontWeight: FontWeight.bold,
      color: ColorStyles.gray60);
  static const pretendardN14Gray60W400 = TextStyle(
      fontFamily: 'Pretendard',
      fontSize: 14,
      fontWeight: FontWeight.w400,
      color: ColorStyles.gray60);
  ...
  static const pretendardN14Gray90 = TextStyle(
      ...
      fontWeight: FontWeight.w600,
      color: ColorStyles.gray90);
  static const pretendardN14Gray90W400 = TextStyle(
      fontFamily: 'Pretendard',
      fontSize: 14,
      fontStyle: FontStyle.normal,
      fontWeight: FontWeight.w400,
      color: ColorStyles.gray90);
  static const pretendardN14Gray40W400 = TextStyle(
      fontFamily: 'Pretendard',
      fontSize: 14,
      fontStyle: FontStyle.normal,
      fontWeight: FontWeight.w400,
      color: ColorStyles.gray40);
  static const pretendardN14White = TextStyle(
      fontFamily: 'Pretendard',
      fontSize: 14,
      fontStyle: FontStyle.normal,
      fontWeight: FontWeight.w600,
